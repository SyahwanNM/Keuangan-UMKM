<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 class="font-semibold text-xl style="color: var(--color-text, #1F2937);" leading-tight">
                {{ __('Laporan Pajak Tahunan') }} - {{ $year }}
            </h2>
            <div class="flex space-x-2">
                <a href="{{ route('taxes.export-annual-pdf', ['year' => $year]) }}" 
    ...
    <div class="py-6 theme-bg">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="dashboard-card overflow-hidden shadow-lg sm:rounded-xl border border-gray-100 mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('taxes.annual-report') }}" class="flex items-center gap-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold style="color: var(--color-text, #1F2937);"">
                                    Rp {{ number_format($annualReport['total_annual_income'], 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold style="color: var(--color-text, #1F2937);"">
                                    Rp {{ number_format($annualReport['total_annual_expense'], 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold" style="color: var(--color-text, #1F2937);">
                                    Rp {{ number_format($annualReport['total_annual_net_income'], 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold style="color: var(--color-text, #1F2937);"">
                                    Rp {{ number_format($annualReport['total_annual_tax'], 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody style="background: var(--color-surface, #FFFFFF);" class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold" style="color: var(--color-text, #1F2937);">
                                        {{ $monthly['month_name_id'] }} {{ $year }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" style="color: var(--color-text, #1F2937);">
                                        Rp {{ number_format($monthly['income'], 0, ',', '.') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" style="color: var(--color-text, #1F2937);">
                                        Rp {{ number_format($monthly['expense'], 0, ',', '.') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" style="color: var(--color-text, #1F2937);">
                                        Rp {{ number_format($monthly['net_income'], 0, ',', '.') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold" style="color: var(--color-text, #1F2937);">
                                        Rp {{ number_format($monthly['calculated_tax'], 0, ',', '.') }}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <script>
        // Monthly Tax Chart
        const monthlyData = @json($annualReport['monthly_reports']);
        const chartData = {
