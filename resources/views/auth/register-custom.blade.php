        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('login.custom') }}" class="border px-4 py-2 rounded-lg font-medium transition" style="color: var(--color-primary, #3B82F6); border-color: var(--color-primary, #3B82F6);" onmouseover="this.style.background='var(--color-primary-light, #DBEAFE)'" onmouseout="this.style.background='transparent'">Masuk</a>
                            ...
                            <div class="glass-form rounded-3xl shadow-2xl p-8 border border-gray-100">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        @error('name')
                                            <p class="mt-1 text-sm" style="color: var(--color-danger, #EF4444);">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select id="business_type" name="business_type" required
                                            ...
                                            <option value="Perdagangan" {{ old('business_type') == 'Perdagangan' ? 'selected' : '' }}>Perdagangan</option>
                                            <option value="Jasa" {{ old('business_type') == 'Jasa' ? 'selected' : '' }}>Jasa</option>
                                            <option value="Manufaktur" {{ old('business_type') == 'Manufaktur' ? 'selected' : '' }}>Manufaktur</option>
                                            <option value="Pertanian" {{ old('business_type') == 'Pertanian' ? 'selected' : '' }}>Pertanian</option>
                                            <option value="Peternakan" {{ old('business_type') == 'Peternakan' ? 'selected' : '' }}>Peternakan</option>
                                            ...
                                            <option value="Teknologi" {{ old('business_type') == 'Teknologi' ? 'selected' : '' }}>Teknologi</option>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="business_address" name="business_address" rows="3" required
                                            ...
                                            placeholder="Contoh: Jl. Merdeka No. 123, Kelurahan ABC, Kecamatan XYZ, Kota/Kabupaten ABC">{{ old('business_address') }}</textarea>
                                ...
                                <div class="mt-6 text-center">
                                    <p class="style="color: var(--color-text_secondary, #6B7280);"">
                                        Sudah punya akun? 
                                        <a href="{{ route('login.custom') }}" class="text-blue-600 hover:text-blue-500 font-semibold">
                                            Masuk di sini
                                        </a>
                                    </p>
                                </div>
