        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('register.custom') }}" class="text-blue-600 border border-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-50 transition">Daftar</a>
                            ...
                            <div class="glass-form rounded-3xl shadow-2xl p-8 border border-gray-100">
                                ...
                                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ route('password.forgot') }}" class="text-sm text-blue-600 hover:text-blue-500 font-medium">
                                            Lupa password?
                                        </a>
                                    </div>
                                ...
                                <div class="mt-6 text-center">
                                    <p class="style="color: var(--color-text_secondary, #6B7280);"">
                                        Belum punya akun? 
                                        <a href="{{ route('register.custom') }}" class="text-blue-600 hover:text-blue-500 font-semibold">
                                            Daftar di sini
                                        </a>
                                    </p>
                                </div>
