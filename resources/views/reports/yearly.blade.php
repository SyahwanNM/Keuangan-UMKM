<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg mb-6" style="background: var(--color-surface, #FFFFFF);">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <h3 class="text-lg font-semibold style="color: var(--color-text, #1F2937);"">Laporan Tahunan</h3>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('reports.export-pdf', ['period' => 'yearly', 'start_date' => $startDate, 'end_date' => $endDate]) }}" 
                ...
                <div class="overflow-hidden shadow-sm sm:rounded-lg" style="background: var(--color-surface, #FFFFFF);">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium style="color: var(--color-text_secondary, #6B7280);"">Jumlah Bulan</p>
            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg mb-6" style="background: var(--color-surface, #FFFFFF);">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4" style="color: var(--color-text, #1F2937);">Detail Bulanan</h3>
