<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg mb-6" style="background: var(--color-surface, #FFFFFF);">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <h3 class="text-lg font-semibold style="color: var(--color-text, #1F2937);"">Laporan Bulanan</h3>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('reports.export-pdf', ['period' => 'monthly', 'start_date' => $startDate, 'end_date' => $endDate]) }}" 
                ...
                <div class="overflow-hidden shadow-sm sm:rounded-lg" style="background: var(--color-surface, #FFFFFF);">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium style="color: var(--color-text_secondary, #6B7280);"">Jumlah Minggu</p>
            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg mb-6" style="background: var(--color-surface, #FFFFFF);">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4" style="color: var(--color-text, #1F2937);">Detail Mingguan</h3>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y" style="border-color: var(--color-border, #E5E7EB);">
                                <thead style="background: var(--color-surface, #F8FAFC);">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" style="color: var(--color-text, #1F2937);">Minggu</th>
