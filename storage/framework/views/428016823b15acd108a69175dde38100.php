                ...
                <div class="flex items-center space-x-3">
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="btn-primary text-white px-6 py-2 rounded-lg font-semibold hover:shadow-lg transition duration-200">Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login.custom')); ?>" class="text-blue-600 border border-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-50 transition">Login</a>
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register.custom')); ?>" class="btn-primary text-white px-6 py-2 rounded-lg font-semibold hover:shadow-lg transition duration-200">Daftar</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="bg-white text-blue-600 px-8 py-4 rounded-xl text-lg font-bold hover:bg-blue-50 transition duration-200 shadow-lg">
                                Buka Dashboard
                            </a>
                        <?php else: ?>
                    <a href="<?php echo e(route('register.custom')); ?>" class="bg-white text-blue-600 px-8 py-4 rounded-xl text-lg font-bold hover:bg-blue-50 transition duration-200 shadow-lg">
                        Daftar
                    </a>
                    <a href="<?php echo e(route('login.custom')); ?>" class="border-2 border-white text-white px-8 py-4 rounded-xl text-lg font-bold hover:bg-white hover:text-blue-600 transition duration-200">
                        Masuk
                    </a>
                        <?php endif; ?>
                    </div>
    ...
    <section class="section-spacing btn-primary">
        <div class="container-custom text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="bg-white text-blue-600 px-10 py-4 rounded-xl text-lg font-bold hover:bg-blue-50 transition duration-200 shadow-lg">
                        Buka Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-600 px-10 py-4 rounded-xl text-lg font-bold hover:bg-blue-50 transition duration-200 shadow-lg">
                        Daftar Sekarang - Gratis
                    </a>
                    <a href="<?php echo e(route('login.custom')); ?>" class="border-2 border-white text-white px-10 py-4 rounded-xl text-lg font-bold hover:bg-white hover:text-blue-600 transition duration-200">
                        Masuk
                    </a>
                <?php endif; ?>
            </div>
...
<?php /**PATH D:\Magang\keuangan-UMKM\resources\views/landing-new.blade.php ENDPATH**/ ?>