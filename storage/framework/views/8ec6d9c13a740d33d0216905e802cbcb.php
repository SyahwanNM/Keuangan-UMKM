<section>
    <header>
        <h2 class="text-lg font-medium style="color: var(--color-text, #1F2937);"">
            <?php echo e(__('Profile Information')); ?>

        </h2>

        <p class="mt-1 text-sm style="color: var(--color-text_secondary, #6B7280);"">
...
<?php endif; ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 style="color: var(--color-text, #1F2937);"">
                        <?php echo e(__('Your email address is unverified.')); ?>


                        <button form="send-verification" class="underline text-sm style="color: var(--color-text_secondary, #6B7280);" hover:style="color: var(--color-text, #1F2937);" rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    <?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm" style="color: var(--color-success, #10B981);">
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                <p
                    ...
                    class="text-sm style="color: var(--color-text_secondary, #6B7280);""
                ><?php echo e(__('Saved.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH D:\Magang\keuangan-UMKM\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>