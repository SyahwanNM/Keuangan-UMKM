        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div x-show="$store.logoutModal?.show || showModal"
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            <h3 class="text-base font-semibold leading-6" style="color: var(--color-text, #1F2937);">
                                <?php echo e(__('Konfirmasi Logout')); ?>

                            </h3>
                            <div class="mt-2">
                                <p class="text-sm" style="color: var(--color-text_secondary, #6B7280);">
                                    <?php echo e(__('Apakah Anda yakin ingin keluar dari aplikasi? Anda akan diarahkan ke halaman login.')); ?>
                ...
                <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6" style="background: var(--color-background, #F8FAFC); border-top: 1px solid var(--color-border, #E5E7EB);">
                    <!-- Logout Button -->
                    <form method="POST" action="<?php echo e(route('logout')); ?>" class="sm:ml-3">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
...
<?php /**PATH D:\Magang\keuangan-UMKM\resources\views/components/logout-modal.blade.php ENDPATH**/ ?>