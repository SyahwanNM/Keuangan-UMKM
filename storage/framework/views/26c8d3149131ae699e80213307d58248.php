...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Halo!</h2>
            <p>Kami menerima permintaan untuk mereset password akun Keuangan UMKM Anda dengan email <strong><?php echo e($email); ?></strong>.</p>
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> Keuangan UMKM. Semua hak dilindungi.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\Magang\keuangan-UMKM\resources\views/emails/password-reset.blade.php ENDPATH**/ ?>