...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl leading-tight" style="color: var(--color-text, #1F2937);">
            <?php echo e(__('Dashboard Keuangan UMKM')); ?>
    ...
    <div class="py-6 theme-bg">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold" style="color: var(--color-text, #1F2937);"><?php echo e($user->business_address ? Str::limit($user->business_address, 30) : 'Belum diisi'); ?></p>
                        </div>
                    </div>
                    <?php if($user->business_address): ?>
                        <div class="mt-4 p-4 rounded-lg" style="background: var(--color-surface, #F9FAFB);">
                            ...
                            <p style="color: var(--color-text, #1F2937);"><?php echo e($user->business_address); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold" style="color: var(--color-text, #1F2937);">Rp <?php echo e(number_format($todayIncome, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold" style="color: var(--color-text, #1F2937);">Rp <?php echo e(number_format($todayExpense, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Laba/Rugi Bulan Ini -->
                <div class="stat-card overflow-hidden shadow-lg sm:rounded-xl border-l-4 <?php echo e($monthlyProfit >= 0 ? 'border-indigo-500' : 'border-amber-500'); ?> hover:shadow-xl transition-all duration-300 <?php echo e($monthlyProfit >= 0 ? 'hover:border-indigo-600' : 'hover:border-amber-600'); ?>">
                    <div class="p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 <?php echo e($monthlyProfit >= 0 ? 'bg-gradient-to-r from-indigo-100 to-blue-100' : 'bg-gradient-to-r from-amber-100 to-yellow-100'); ?> rounded-full flex items-center justify-center">
                                    <svg class="w-4 h-4" style="color: <?php echo e($monthlyProfit >= 0 ? 'var(--color-primary, #3B82F6)' : 'var(--color-warning, #F59E0B)'); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                    </svg>
                                </div>
                            </div>
                            <div class="ml-4">
                                <p class="text-sm font-medium" style="color: var(--color-text_secondary, #6B7280);"><?php echo e($monthlyProfit >= 0 ? 'Laba' : 'Rugi'); ?> Bulan Ini</p>
                                <p class="text-2xl font-semibold" style="color: <?php echo e($monthlyProfit >= 0 ? 'var(--color-primary, #3B82F6)' : 'var(--color-warning, #F59E0B)'); ?>;">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold" style="color: var(--color-text, #1F2937);">Rp <?php echo e(number_format($totalCapital, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div class="stat-card overflow-hidden shadow-lg sm:rounded-xl border-l-4 <?php echo e($currentBalance >= 0 ? 'border-emerald-500' : 'border-red-500'); ?> hover:shadow-xl transition-all duration-300 <?php echo e($currentBalance >= 0 ? 'hover:border-emerald-600' : 'hover:border-red-600'); ?>">
                    <div class="p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 <?php echo e($currentBalance >= 0 ? 'bg-gradient-to-r from-emerald-100 to-green-100' : 'bg-gradient-to-r from-red-100 to-rose-100'); ?> rounded-full flex items-center justify-center">
                                    <svg class="w-4 h-4" style="color: <?php echo e($currentBalance >= 0 ? 'var(--color-success, #10B981)' : 'var(--color-danger, #EF4444)'); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold" style="color: <?php echo e($currentBalance >= 0 ? 'var(--color-success, #10B981)' : 'var(--color-danger, #EF4444)'); ?>;">
                                    Rp <?php echo e(number_format($currentBalance, 0, ',', '.')); ?>

                                </p>
                                <p class="text-xs mt-1" style="color: var(--color-text_secondary, #6B7280);">
                                    <?php echo e($currentBalance >= 0 ? 'Positif' : 'Negatif'); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-semibold" style="color: var(--color-text, #1F2937);">+ Rp <?php echo e(number_format($totalCapital, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm" style="color: var(--color-text_secondary, #6B7280);">Total Pemasukan</span>
                                <span class="text-sm font-semibold" style="color: var(--color-success, #10B981);">+ Rp <?php echo e(number_format($totalIncome, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm" style="color: var(--color-text_secondary, #6B7280);">Total Pengeluaran</span>
                                <span class="text-sm font-semibold" style="color: var(--color-danger, #EF4444);">- Rp <?php echo e(number_format($totalExpense, 0, ',', '.')); ?></span>
                            </div>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-bold" style="color: <?php echo e($currentBalance >= 0 ? 'var(--color-success, #10B981)' : 'var(--color-danger, #EF4444)'); ?>;">
                                    Rp <?php echo e(number_format($currentBalance, 0, ',', '.')); ?>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="<?php echo e(route('taxes.index')); ?>" class="text-sm font-medium" style="color: var(--color-primary, #3B82F6);" onmouseover="this.style.color='var(--color-primary-dark, #1D4ED8)'" onmouseout="this.style.color='var(--color-primary, #3B82F6)'">Kelola Pajak</a>
                            </div>
                        </div>
                        <?php if($upcomingTaxes->count() > 0): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $upcomingTaxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-3 rounded-lg" style="background: var(--color-surface, #FEF3C7);">
                                        <div>
                                            <p class="font-medium" style="color: var(--color-text, #1F2937);"><?php echo e($tax->name); ?></p>
                                            <p class="text-sm" style="color: var(--color-text_secondary, #6B7280);">Jatuh tempo: <?php echo e($tax->due_date->format('d M Y')); ?></p>
                                        </div>
                                        <div class="text-right">
                                            <p class="font-semibold" style="color: var(--color-text, #1F2937);">Rp <?php echo e(number_format($tax->amount, 0, ',', '.')); ?></p>
                                        </div>
                                    </div>
            ...
            <div class="stat-card overflow-hidden shadow-lg sm:rounded-xl border border-gray-100">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="<?php echo e(route('transactions.index')); ?>" class="text-sm font-medium" style="color: var(--color-primary, #3B82F6);" onmouseover="this.style.color='var(--color-primary-dark, #1D4ED8)'" onmouseout="this.style.color='var(--color-primary, #3B82F6)'">Lihat Semua</a>
                    </div>
    ...
    <script>
        ...
        document.getElementById('dashboardAutoCalculateBtn').addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("taxes.auto-calculate")); ?>', {
                method: 'POST',
                headers: {
...
<?php endif; ?>
<?php /**PATH D:\Magang\keuangan-UMKM\resources\views/dashboard.blade.php ENDPATH**/ ?>