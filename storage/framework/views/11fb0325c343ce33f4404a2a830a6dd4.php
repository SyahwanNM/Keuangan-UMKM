...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="<?php echo e(route('theme.update')); ?>" method="POST" id="theme-form">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="theme" value="light" <?php echo e($preferences->theme == 'light' ? 'checked' : ''); ?> class="sr-only">
                                        <div class="p-4 border-2 rounded-lg <?php echo e($preferences->theme == 'light' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="theme" value="dark" <?php echo e($preferences->theme == 'dark' ? 'checked' : ''); ?> class="sr-only">
                                        <div class="p-4 border-2 rounded-lg <?php echo e($preferences->theme == 'dark' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200">
                                            <div class="text-center">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="theme" value="auto" <?php echo e($preferences->theme == 'auto' ? 'checked' : ''); ?> class="sr-only">
                                        <div class="p-4 border-2 rounded-lg <?php echo e($preferences->theme == 'auto' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200">
                                            <div class="text-center">
                        ...
                        <div class="overflow-hidden shadow-lg sm:rounded-xl theme-surface" style="border: 1px solid var(--color-text_secondary, #6B7280); position: relative; z-index: 2;">
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $colorSchemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $colors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="relative cursor-pointer">
                                            <input type="radio" name="color_scheme" value="<?php echo e($key); ?>" <?php echo e($preferences->color_scheme == $key ? 'checked' : ''); ?> class="sr-only">
                                            <div class="p-4 border-2 rounded-lg <?php echo e($preferences->color_scheme == $key ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200">
                                                <div class="text-center">
                                                    <div class="w-8 h-8 rounded-full mx-auto mb-2" style="background: linear-gradient(45deg, <?php echo e($colors['primary']); ?>, <?php echo e($colors['secondary']); ?>)"></div>
                                                    <div class="text-sm font-medium" style="color: var(--color-text, #1F2937);"><?php echo e($colors['name']); ?></div>
                                                </div>
                                            </div>
                                        </label>
                        ...
                        <div class="overflow-hidden shadow-lg sm:rounded-xl theme-surface" style="border: 1px solid var(--color-text_secondary, #6B7280); position: relative; z-index: 2;">
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="font_size" value="small" <?php echo e($preferences->font_size == 'small' ? 'checked' : ''); ?> class="sr-only">
                                        <div class="p-4 border-2 rounded-lg <?php echo e($preferences->font_size == 'small' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200 text-center">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="font_size" value="medium" <?php echo e($preferences->font_size == 'medium' ? 'checked' : ''); ?> class="sr-only">
                                        <div class="p-4 border-2 rounded-lg <?php echo e($preferences->font_size == 'medium' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200 text-center">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="font_size" value="large" <?php echo e($preferences->font_size == 'large' ? 'checked' : ''); ?> class="sr-only">
                                        <div class="p-4 border-2 rounded-lg <?php echo e($preferences->font_size == 'large' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> transition-all duration-200 text-center">
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="show_animations" value="1" <?php echo e($preferences->show_animations ? 'checked' : ''); ?> class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                        <span class="ml-3 text-sm style="color: var(--color-text_secondary, #6B7280);"">Tampilkan Animasi</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="show_tooltips" value="1" <?php echo e($preferences->show_tooltips ? 'checked' : ''); ?> class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <select name="date_format" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="d-m-Y" <?php echo e($preferences->date_format == 'd-m-Y' ? 'selected' : ''); ?>>DD-MM-YYYY</option>
                                            <option value="m/d/Y" <?php echo e($preferences->date_format == 'm/d/Y' ? 'selected' : ''); ?>>MM/DD/YYYY</option>
                                            <option value="Y-m-d" <?php echo e($preferences->date_format == 'Y-m-d' ? 'selected' : ''); ?>>YYYY-MM-DD</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="time_format" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="24" <?php echo e($preferences->time_format == '24' ? 'selected' : ''); ?>>24 Jam</option>
                                            <option value="12" <?php echo e($preferences->time_format == '12' ? 'selected' : ''); ?>>12 Jam (AM/PM)</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="number_format" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="dot" <?php echo e($preferences->number_format == 'dot' ? 'selected' : ''); ?>>Titik (1.000.000)</option>
                                            <option value="comma" <?php echo e($preferences->number_format == 'comma' ? 'selected' : ''); ?>>Koma (1,000,000)</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="language" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="id" <?php echo e($preferences->language == 'id' ? 'selected' : ''); ?>>Indonesia</option>
                ...
                <div class="mt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                        <a href="<?php echo e(route('dashboard')); ?>" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200">
                            Batal
                        </a>
    ...
    <script>
        function resetTheme() {
            if (confirm('Apakah Anda yakin ingin mereset tema ke pengaturan default?')) {
                ...
                fetch('<?php echo e(route("theme.reset")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        function previewTheme() {
            ...
            fetch('<?php echo e(route("theme.preview")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json',
        ...
        function applyThemeChanges() {
            ...
            if (filteredData.theme || filteredData.color_scheme) {
                ...
                const tempPreferences = {
                    theme: filteredData.theme || '<?php echo e($preferences->theme); ?>',
                    color_scheme: filteredData.color_scheme || '<?php echo e($preferences->color_scheme); ?>',
                    font_size: filteredData.font_size || '<?php echo e($preferences->font_size); ?>'
                };
...
<?php /**PATH D:\Magang\keuangan-UMKM\resources\views/theme/index.blade.php ENDPATH**/ ?>